...
Obiettivo:
Implementare un sistema di gestione dell'inventario per un negozio utilizzando Java.
Il sistema dovrà gestire diverse categorie di articoli,
permettendo l'aggiunta, la rimozione e la visualizzazione degli articoli.
Si utilizzeranno concetti avanzati come HashSet, gestione dei valori null, classi astratte e interfacce.
Requisiti:
...
public class Main {
    public static void main(String[] args) {
        Book book = new Book("augf", 43.5, "shdus");
        Electronic electronic = new Electronic("ahahd", 56.6, "Inasa");
        InventoryManage x = new InventoryManage();

        x.addItem(book);
        x.addItem(electronic);
        System.out.println();
        x.displayInventory();
        System.out.flush();
        Book book2 = null;
